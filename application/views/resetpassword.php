			...
			<section class="w-100 float-left wrap-signup pt-3 pb-5">
				<div class="container">
					...
					<div class="row">
						...
						<form name="frmReset" method="post" action="<?php echo base_url('Forgotpassword/resetpassword');?>" class="col-lg-6 col-md-12 col-12 float-left">
							<div class="w-100 float-left wrap-section-sign account-sett mb-3 mt-3">
								...
								<div class="col-lg-12 float-left wrap-sign-main">
									...
									<input type="text" class="input-class-common  w-100 float-left" name="txtEmail" id="txtEmail" required=""  value="<?php echo $this->session->userdata('email');?>" readonly="">
								</div>
								<div class="col-lg-12 float-left wrap-sign-main">

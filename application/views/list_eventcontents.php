                              ...
                              <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                      <?php 
                                                            if(isset($uvalue['details']['pdf_name'])){
                                                      ?>
                                                      <a href="<?php echo base_url('assets/content/'.$uvalue['details']['pdf_name']);?>">Show PDF file</a>    
                                                      <?php
                                                            }
                                                      ?>
                                                ...
                                                <td>
                                                      <a href="<?php echo base_url('content_management/edit_event/'.base64_encode($uvalue['id']));?>"><i class="fa fa-edit" style="font-size:12px;color:green"></i></a>

                                                      <a href="<?php echo base_url('content_management/remove_event_content/'.base64_encode($uvalue['id']));?>"><i class="fa fa-trash" style="font-size:12px;color:red"></i></a>                                                      
                                                </td>
                                          </tr>
                                          <?php $i++;}}else{?>

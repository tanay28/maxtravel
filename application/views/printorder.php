					...
					<div class="hotel-name float-left">
						...
						<div class="w-100 float-left bottom-info-hotels mt-2">
							<div
								...
								<input type="text" name="cart[<?php echo $cartvalue['id'];?>][producttotamount]" id="producttotamount_<?php echo $i;?>" class="full-price float-right totprice" value="<?php echo $productTotAmount;?>" disable>

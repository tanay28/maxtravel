...
<section class="w-100 float-left wrap-signup pt-3 pb-5">
	<div class="col-lg-12">
		<div class="w-100 float-left agent-dashboard">
			...
			<div class="w-100 float-left mb-5">
				<div class="col-lg-4 col-md-12 col-12 float-left wrap-tot-wall-amount">
					<div class="w-100 float-left wrap-inner-amount">
						<h5>Total Credit Points</h5>
						<span style="color: white;">In Last Month</span>
						<h2><!-- <i class="fas fa-rupee-sign"></i> --> 700</h2>
					</div>
				</div>
				<div class="col-lg-4 col-md-12 col-12 float-left wrap-tot-wall-amount">
					<div class="w-100 float-left wrap-inner-amount">
						<h5>Total Debit Points</h5>
						<span style="color: white;">In Last Month</span>
				...
				<div class="col-lg-4 col-md-12 col-12 float-left wrap-tot-wall-amount">
					<div class="w-100 float-left wrap-inner-amount">
						...
						<h2><!-- <i class="fas fa-rupee-sign"></i> --> 3</h2>
					</div>
				</div>
			...
			<div class="w-100 float-left mb-5">
				<div class="col-lg-12 col-md-12 col-12 float-left wrap-transaction-graph mt-4">

      ...
      <div class="container">
            ...
            <div class="row">
                  <div class="col-lg-12 float-left page-title-top mt-3">
                        <h1>Destination Content List</h1>
                  </div>
                                    ...
                                    <tbody>
                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                      ...
                                                      <a href="<?php echo base_url('content_management/remove_destination_content/'.base64_encode($uvalue['id']));?>"><i class="fa fa-trash" style="font-size:12px;color:red"></i></a>                                                      
                                                </td>
                                          </tr>
                                          <?php $i++;}}else{?>

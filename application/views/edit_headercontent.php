		...
		<div class="row">
			...
			<form name="frmContent" action="" method="POST" enctype='multipart/form-data'>
						...
						<div class="w-100 float-left">
							...
							<div class="col-12 col-md-12 col-lg-6 float-left wr-form p-0">
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
									<label class="float-left">Slider Name</label>
									<input type="text" name="txtslider_name" required="" class="input-class-common float-left" value="<?php echo isset($sliderDetails[0]['slider_name']) ? $sliderDetails[0]['slider_name'] : ''?>">
								</div>
				...
				<div class="col-lg-12 float-left mt-4">
					...
					<a href="<?php echo base_url('content_management/view_header');?>" class="cancel-button-form float-left">Cancel</a>
				</div>
			</form>
		</div>

...
<section class="w-100 float-left wrap-signup pt-3 pb-5">
	<div class="container">
		...
		<div class="row">
			...
			<form name="frmAdd" action="<?php echo base_url('content_management/header');?>" method="POST" enctype='multipart/form-data'>
				<div class="col-lg-12 float-left">
						...
						<div class="w-100 float-left">
							...
							<div class="col-12 col-md-12 col-lg-6 float-left wr-form p-0">
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
									...
									<input type="text" name="txtslider_name" required="" class="input-class-common float-left">
								</div>
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
									<label class="float-left">Tag Name</label>
									<input type="text" name="txttag_name" required="" class="input-class-common float-left">
								</div>
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
									<label class="float-left">Trip Duration</label>
				...
				<div class="col-lg-12 float-left mt-4">
					...
					<a href="<?php echo base_url('content_management/view_header');?>" class="register-button-form float-left mr-3">View Content</a>

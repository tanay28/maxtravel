                  ...
                  <div class="col-lg-12 float-left">
                        <div class="w-100 float-left wrap-section-sign account-sett my-account-details mb-3 mt-3">
                              ...
                              <div class="col-lg-4 col-md-6 col-12 float-left wrap-sign-main">
                                    ...
                                    <h4 class="w-100 float-left"><?php echo isset($profiledetails[0]['name']) ? $profiledetails[0]['name'] : '';?></h4>
                              </div>
                              <div class="col-lg-4 col-md-6 col-12 float-left wrap-sign-main">
                              ...
                              <div class="col-lg-4 col-md-6 col-12 float-left wrap-sign-main">
                                    <label class="float-left  text-uppercase">Phone No. </label>
                                    <h4 class="w-100 float-left"><?php echo isset($profiledetails[0]['phoneno']) ? $profiledetails[0]['phoneno'] : '';?></h4>
                              </div>
                              <div class="col-lg-4 col-md-6 col-12 float-left wrap-sign-main">

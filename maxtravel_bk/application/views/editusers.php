	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 float-left page-title-top mt-3">
				<h1>Edit Users (You Can Admin User)</h1>
			</div>
			...
			<form name="frmEdituser" action="" method="POST" enctype='multipart/form-data'>
				<div class="col-lg-12 float-left">
						...
						<div class="w-100 float-left">
							...
							<div class="col-12 col-md-12 col-lg-6 float-left wr-form p-0">
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
									...
									<input type="text" name="name" required="" class="input-class-common float-left" value="<?php echo isset($userDetails[0]['name']) ? $userDetails[0]['name'] : ''?>">
								</div>
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
									<label class="float-left">Email 
									</label>
									<input type="text" name="email" required="" class="input-class-common float-left" pattern="[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}" value="<?php echo isset($userDetails[0]['email']) ? $userDetails[0]['email'] : ''?>" readonly="">
								</div>
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
								...
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
									...
									<input type="text" name="phoneno" required="" class="input-class-common float-left" pattern="[1-9]{1}[0-9]{9}" title="Enter 10 digit mobile number" value="<?php echo isset($userDetails[0]['phoneno']) ? $userDetails[0]['phoneno'] : ''?>">
								</div>
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
									<label class="float-left">Address 
									</label>
									<textarea name="address" class="input-class-common float-left text-area"><?php echo isset($userDetails[0]['address']) ? $userDetails[0]['address'] : ''?></textarea>
								</div>
								<div class="col-lg-12 col-md-12 col-12 float-left wrap-sign-main">
				...
				<div class="col-lg-12 float-left mt-4">
					<input type="submit" value="Update User" class="register-button-form float-left mr-3 ">

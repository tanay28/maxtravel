...
<section class="w-100 float-left wrap-signup pt-3 pb-5">
	<div class="container">
		...
		<div class="row">
			...
			<form name="frmAddemployee" action="" method="POST" enctype='multipart/form-data'>
				<div class="col-lg-12 float-left">
				...
				<div class="col-lg-12 float-left mt-4">
					<input type="submit" value="Add Employee" class="register-button-form float-left mr-3 ">
